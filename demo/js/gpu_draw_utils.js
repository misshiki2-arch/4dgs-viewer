...
export function buildDrawStats({ visibleCount = 0, drawData = null, mode = null, focusTileId = -1, focusTileIds = [], tileBatchSummary = null, executionSummary = null, packedScreenSpace = null, packedUploadSummary = null } = {}) {
  ...
  return {
    ...
    packedDirectUsesGpuResidentPayload: !!packedUploadSummary?.packedDirectUsesGpuResidentPayload,
    packedDirectSharedSetupCount: normalizeCount(packedUploadSummary?.packedDirectSharedSetupCount),
    packedDirectSharedBindCount: normalizeCount(packedUploadSummary?.packedDirectSharedBindCount),
    packedDirectSharedDispatchCount: normalizeCount(packedUploadSummary?.packedDirectSharedDispatchCount),
    packedDirectSharedDispatchMode: packedUploadSummary?.packedDirectSharedDispatchMode ?? 'none',
    packedDirectSharedPayloadCount: normalizeCount(packedUploadSummary?.packedDirectSharedPayloadCount),
    packedDirectSharedMergeCopyCount: normalizeCount(packedUploadSummary?.packedDirectSharedMergeCopyCount),
    packedDirectSharedMergeAttempted: !!packedUploadSummary?.packedDirectSharedMergeAttempted,
    packedDirectSharedMergeFailureReason: packedUploadSummary?.packedDirectSharedMergeFailureReason ?? 'none',
    packedDirectSharedMergeTextureWidth: normalizeCount(packedUploadSummary?.packedDirectSharedMergeTextureWidth),
    packedDirectSharedMergeTextureHeight: normalizeCount(packedUploadSummary?.packedDirectSharedMergeTextureHeight),
    packedDirectSharedMergeRowCount: normalizeCount(packedUploadSummary?.packedDirectSharedMergeRowCount),
    packedDirectSharedMergeRowsPerColumn: normalizeCount(packedUploadSummary?.packedDirectSharedMergeRowsPerColumn),
    packedDirectSharedMergeColumnCount: normalizeCount(packedUploadSummary?.packedDirectSharedMergeColumnCount),
    packedDirectSharedMergePolicySelectedPath: packedUploadSummary?.packedDirectSharedMergePolicySelectedPath ?? 'none',
    packedDirectSharedMergePolicyReason: packedUploadSummary?.packedDirectSharedMergePolicyReason ?? 'none',
    packedDirectSharedMergePolicyEstimatedCopyCount: normalizeCount(packedUploadSummary?.packedDirectSharedMergePolicyEstimatedCopyCount),
    packedDirectSharedMergePolicyEstimatedDispatchSavings: normalizeCount(packedUploadSummary?.packedDirectSharedMergePolicyEstimatedDispatchSavings),
    packedDirectSharedMergePolicyAtlasArea: normalizeCount(packedUploadSummary?.packedDirectSharedMergePolicyAtlasArea),
    packedDirectSharedMergePolicyOverrideMode: packedUploadSummary?.packedDirectSharedMergePolicyOverrideMode ?? 'none',
    packedDirectSharedMergePolicyOverrideReason: packedUploadSummary?.packedDirectSharedMergePolicyOverrideReason ?? 'none',
    packedDirectSharedMergeAtlasReused: !!packedUploadSummary?.packedDirectSharedMergeAtlasReused,
    packedDirectSharedMergeAtlasRebuilt: !!packedUploadSummary?.packedDirectSharedMergeAtlasRebuilt,
    packedDirectSharedMergeAtlasChurnReason: packedUploadSummary?.packedDirectSharedMergeAtlasChurnReason ?? 'none',
    packedDirectSharedMergeAtlasCapacityWidth: normalizeCount(packedUploadSummary?.packedDirectSharedMergeAtlasCapacityWidth),
    packedDirectSharedMergeAtlasCapacityHeight: normalizeCount(packedUploadSummary?.packedDirectSharedMergeAtlasCapacityHeight),
    packedDirectSharedMergeAtlasAllocationBytes: normalizeCount(packedUploadSummary?.packedDirectSharedMergeAtlasAllocationBytes),
    packedDirectSharedMergeAtlasSavedAllocationBytes: normalizeCount(packedUploadSummary?.packedDirectSharedMergeAtlasSavedAllocationBytes),
    packedDirectGpuResidentPayloadAvailable: !!packedUploadSummary?.packedDirectGpuResidentPayloadAvailable,

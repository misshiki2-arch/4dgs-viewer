...
export function uploadAndDrawPackedDirect(gl, gpu, packedScreenSpace, canvasWidth, canvasHeight, options = {}) {
  ...
  if (drawResult) {
    ...
    return {
      ...
      packedDirectSharedMergePolicySelectedPath: drawResult.mergePolicySelectedPath ?? 'none',
      packedDirectSharedMergePolicyReason: drawResult.mergePolicyReason ?? 'none',
      ...
      packedDirectSharedMergeAtlasCapacityWidth: drawResult.mergeAtlasCapacityWidth ?? 0,
      packedDirectSharedMergeAtlasCapacityHeight: drawResult.mergeAtlasCapacityHeight ?? 0,
      packedDirectSharedMergeAtlasAllocationBytes: drawResult.mergeAtlasAllocationBytes ?? 0,
      packedDirectSharedMergeAtlasSavedAllocationBytes: drawResult.mergeAtlasSavedAllocationBytes ?? 0,
      uploadCount: 0,
  ...
  return {
    ...
    packedDirectSharedMergePolicySelectedPath: 'none',
    packedDirectSharedMergePolicyReason: 'none',
    ...
    packedDirectSharedMergeAtlasCapacityWidth: 0,
    packedDirectSharedMergeAtlasCapacityHeight: 0,
    packedDirectSharedMergeAtlasAllocationBytes: 0,
    packedDirectSharedMergeAtlasSavedAllocationBytes: 0,
    uploadCount: 1,
    packedDirectDraw: true,

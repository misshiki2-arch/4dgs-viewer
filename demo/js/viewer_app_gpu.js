  ...
  const runtimeResult = await runWebGpuVisibleRecordDryRunFromViewerState({
    ...
    metadataOverrides: {
      ...
      phase:
        ...
        options.comparisonMode.includes('step105')
          ? 'phase3-step105'
          : typeof options.comparisonMode === 'string' &&
        options.comparisonMode.includes('step104')
          ? 'phase3-step104'
          : typeof options.comparisonMode === 'string' &&
        options.comparisonMode.includes('step103')
          ? 'phase3-step103'
          : typeof options.comparisonMode === 'string' &&
        options.comparisonMode.includes('step102')
          ? 'phase3-step102'
          : typeof options.comparisonMode === 'string' &&

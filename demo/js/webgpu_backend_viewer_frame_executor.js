...
export const WEBGPU_BACKEND_VIEWER_FRAME_EXECUTOR_CONTRACT_VERSION =
  'phase3-step67-backend-viewer-frame-executor-boundary-v1';
...
export async function executeWebGpuBackendViewerFrame({
  ...
  const summary = {
    ...
    source:
      'Phase 3 Step67 viewer backend frame executor delegates uniform and selected sample buffer consumption ownership through the runtime runner',
    contractVersion: WEBGPU_BACKEND_VIEWER_FRAME_EXECUTOR_CONTRACT_VERSION,
